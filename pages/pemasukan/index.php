<div class="container-fluid">
    ...
    <!-- end page title -->
    <!-- end page title -->
    <button class="btn btn-primary mb-3" id="tambah">Tambah Pemasukan</button>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
...
<script>
    function loadTable() {
        $('#tabel').load('pages/pemasukan/tabel-pemasukan.php');
    }
    $(document).ready(function () {
        ...
        $('#tambah').click(function () {
            ...
            $('.modal-body').load('pages/pemasukan/tambah-pemasukan.php');
        });
    });
</script>